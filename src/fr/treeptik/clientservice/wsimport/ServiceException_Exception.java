 ...
 * 
 */
@WebFault(name = "ServiceException", targetNamespace = "http://webservice.service.treeptik.fr/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: fr.treeptik.clientservice.wsimport.ServiceException
     */
